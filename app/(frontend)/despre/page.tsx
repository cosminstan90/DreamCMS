...
export default async function AboutPage() {
  ...
  return (
    <StaticPageShell
      ...
      eyebrow="Trust"
      title={dreamy ? 'Despre Pagani' : 'Despre Numar Angelic'}
      intro={dreamy
        ? 'Construim un proiect editorial romanesc despre interpretarea viselor, rugaciuni si ghiduri spirituale, cu accent pe claritate, context si transparenta fata de cititor.'
    ...
    >
      {dreamy ? (
        <>
          <p>
            Pagani organizeaza continut despre vise si rugaciuni in articole, interpretari tematice si pagini de dictionar. Scopul nostru este sa oferim
            raspunsuri usor de parcurs, bine structurate si utile pentru cititorii care cauta sens, liniste si ghiduri spirituale.
          </p>
          <p>
